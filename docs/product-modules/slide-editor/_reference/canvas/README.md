...
| File | Description |
|------|-------------|
| [slide-canvas.md](./slide-canvas.md) | Technical spec for the SlideCanvas component (Remotion Player integration, 16:9 rendering) |
| [element-properties.md](./element-properties.md) | Technical spec for the element properties panel component |
